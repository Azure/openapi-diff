...
describe("index", () => {
  it("get json point from json path", () => {
    ...
    equal(result, "/paths/Mircosoft.Compute~1resoucemaneger/operation/get/1/past")
    result = pathToJsonPointer("")
    equal(result, "")
    result = pathToJsonPointer("paths['Mircosoft.Compute~resoucemaneger/test'].operation.get[1].past")
    equal(result, "/paths/Mircosoft.Compute~0resoucemaneger~1test/operation/get/1/past")
    result = pathToJsonPointer("paths['Mircosoft.Compute~resouce.maneger/test'].operation.get[1].past")
    equal(result, "/paths/Mircosoft.Compute~0resouce.maneger~1test/operation/get/1/past")
    result = pathToJsonPointer(
