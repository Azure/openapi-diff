...
describe("index", () => {
  it("get json point from json path", ()=> {
    ...
    result = pathToJsonPointer("paths['/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}'].put.parameters[3]")
    assert.equal(result,"/paths/~1subscriptions~1{subscriptionId}~1resourceGroups~1{resourceGroupName}~1providers~1Microsoft.Network~1loadBalancers~1{loadBalancerName}/put/parameters/3")
  })
})